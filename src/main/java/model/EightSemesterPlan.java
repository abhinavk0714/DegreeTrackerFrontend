...
public class EightSemesterPlan {
    ...
    */
    ...
    public String toString() {
        ...
        stringBuilder.append("Eight Semester Plan - \n");
        for (int i = 0; i < semesters.size(); i++) {
            stringBuilder.append("Semester ").append(i + 1).append(":\n");
            if (semesters.get(i) != null) {
                for (Course course : semesters.get(i)) {
        ...
        stringBuilder.append("Application Area Courses:\n");
